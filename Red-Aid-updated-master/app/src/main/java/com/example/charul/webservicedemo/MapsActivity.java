...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        check =  getIntent().getStringExtra("var");
        ...
        enterloc = (Button)findViewById(R.id.nope);
        checkbtn = (Button)findViewById(R.id.button6);

        checkbtn.setOnClickListener(this);
        submit.setOnClickListener(this);
        enterloc.setOnClickListener(this);
     ...
     //   checkbtn.setVisibility(View.INVISIBLE);
       ...
       /* check =  getIntent().getStringExtra("var");
        ...
        getSupportActionBar().setTitle("Red Aid");


        //to place a map in an app
        getSupportActionBar().setTitle("Red Aid");
    ...
    public void onConnected(Bundle bundle) {
        ...
        mLocationRequest.setInterval(1000); //show changed location after every 1000msec
    ...
    public void onClick(View view) {
        ...
        if(view == submit) {
            ...
            Intent b = new Intent(MapsActivity.this, BloodGroup.class);
            b.putExtra("long", longitude);
            b.putExtra("lat", latitude);
            startActivity(b);
        }

        else if(view == enterloc){
            finish();
            Intent b=new Intent(MapsActivity.this,need_loc.class);
            startActivity(b);
            ...
            finish();
            Intent b = new Intent(MapsActivity.this, Profile_map.class);
            startActivity(b);
        }
